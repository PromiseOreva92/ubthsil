...
<html lang="en">
   <head>
      ...
      <title>UBTH Staff Investment Limited</title>
      <!-- Favicon -->
      <link rel="shortcut icon" href="images/favicon.ico" />
      <!-- Bootstrap CSS -->
      <link rel="stylesheet" href="{{asset('c_assets/css/bootstrap.min.css')}}">
      <!-- Chart list Js -->
      <link rel="stylesheet" href="{{asset('c_assets/js/chartist/chartist.min.css')}}">
      <!-- Typography CSS -->
      <link rel="stylesheet" href="{{asset('c_assets/css/typography.css')}}">
      <!-- Style CSS -->
      <link rel="stylesheet" href="{{asset('c_assets/css/style.css')}}">
      <!-- Responsive CSS -->
      <link rel="stylesheet" href="{{asset('c_assets/css/responsive.css')}}">
            ...
            <div class="container-fluid">
                           ...
                           <div class="tab-pane fade active show" id="personal-information" role="tabpanel">
                               <div class="iq-card">
                                 ...
                                 <div class="iq-card-body">
                                    <img src="{{asset('public/document')}}/{{$document->doc_image}}" alt="" class="img-fluid">
                                 </div>
                              </div>
                           </div>
                ...
                <div class="row">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h6 class="mb-0">{{$transaction->user->fullname}} ({{$transaction->user->designation}}):- </h6>
                                            <p class="mb-0"><b>{{$transaction->comment}} </b></p>
                                        </td>
                                        
                                        <td class="text-center"><b>{{date('jS F Y',strtotime($transaction->created_at))}} </b></td>
                                    </tr>
                                    @php
                                        $count++;
                                    @endphp
                    ...
                    <div class="col-sm-6 text-right">
                        <a href="../print_document/{{$document->id}}" class="btn btn-link mr-3" rel="noopener" target="_blank" ><i class="ri-printer-line"></i> Download Print</button>
                    </div>
