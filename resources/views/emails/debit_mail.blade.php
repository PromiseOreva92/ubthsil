...
<h2 style="text-center">Debit Transaction!</h2>
<p style="margin-top:20px;font-size:16px">Dear {{$user->firstname}} {{$user->lastname}}</p>
<p style="margin-top:20px;font-size:16px">A debit transaction has occured on your account. The details are below:</p>
